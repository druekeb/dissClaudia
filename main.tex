...
\usepackage[backend=biber,bibencoding=utf8, style=authoryear, autocite=inline, labeldate=true, uniquename=full, uniquelist=true]{biblatex}
...
{\Large \textbf{Verzeichnis der Abkürzungen}}
...
%\newgeometry{a4paper,left=30mm,right=30mm, top=25mm, bottom=25mm}
\appendix
\pagestyle{empty}
\addtocontents{toc}{%
