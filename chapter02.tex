...
\begin{figure}[H]
  ...
  \caption{ Überblick über die Forschung zu Europäisierung und Konditionalisierung\\(Quelle: in Anlehnung an \cite{huszak}:75) }
\end{figure}
...
%}
\end{table}
Quelle: nach \cite{moller}:4 (eigene Ergänzung zu Vertrag von Lissabon)
...
\end{figure}
Quelle: in Anlehnung an \cite{wessels}:449\par
...
\end{tabular}
\end{table}
Quellen: EU website; * \cite{mus}:12; ** \cite{brusgal}:59. 
...
\end{table}
Quelle: \cite{eurcom11b}:15 (eigene Übersetzung aus dem Englischen)
...
\end{table}
Quelle: \cite{zink}:8 (eigene Übersetzung aus dem Englischen)
...
\end{table}
Quelle: \cite{ips}:96 (eigene Übersetzung aus dem Englischen)
